...
<body>    
    ...
    <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
      ...
      <h2>Bem vindo(a), <?php echo $usuario; ?></h2>  
        <h1 class="display-4 fw-bold lh-1">Importar dados do arquivo .TXT</h1>
        <p class="lead">Seus dados serão importados para o banco de dados e ficarão disponiveis para sua visualização .</p>
